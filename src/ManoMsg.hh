...
namespace TSP__PortType {
	...
	class ManoMsg : public ManoMsg_BASE {
		...
		private:
            ...
            //std::future<std::map<std::string, std::vector<std::string>>> monitor_futures;
			...
			class Monitor {
                ...
                public:
                    Monitor(std::string vnf_name, std::vector<std::string> metrics, std::string docker_rest_url);
