...
# for dark (dark@development) on Thu Jul 12 23:03:56 2018
...
ifndef TTCN3_DIR
TTCN3_DIR = /home/dark/titan.core/Install
endif
...
TTCN3_MODULES = src/ServiceProfiling_Functions.ttcn src/ServiceProfiling_PortType.ttcn src/ServiceProfiling_Templates.ttcn src/ServiceProfiling_Testcases.ttcn src/ServiceProfiling_Types.ttcn
...
# this project:
GENERATED_SOURCES = build/ServiceProfiling_Functions.cc build/ServiceProfiling_PortType.cc build/ServiceProfiling_Templates.cc build/ServiceProfiling_Testcases.cc build/ServiceProfiling_Types.cc
GENERATED_HEADERS = build/ServiceProfiling_Functions.hh build/ServiceProfiling_PortType.hh build/ServiceProfiling_Templates.hh build/ServiceProfiling_Testcases.hh build/ServiceProfiling_Types.hh

# C/C++ Source & header files of Test Ports, external functions and
# other modules:
USER_SOURCES = src/ManoMsg.cc
USER_HEADERS = src/ManoMsg.hh

# Object files of this project that are needed for the executable test suite:
OBJECTS = $(GENERATED_OBJECTS) $(USER_OBJECTS)

GENERATED_OBJECTS = build/ServiceProfiling_Functions.o build/ServiceProfiling_PortType.o build/ServiceProfiling_Templates.o build/ServiceProfiling_Testcases.o build/ServiceProfiling_Types.o

USER_OBJECTS = build/ManoMsg.o

# Other files of the project (Makefile, configuration files, etc.)
# that will be added to the archived source files:
OTHER_FILES = src/config.cfg Makefile

# The name of the executable test suite:
EXECUTABLE = build/nfv-service-profiling
...
LINUX_LIBS = -lxml2 -ljsoncpp -lyaml-cpp -lcpprest -lboost_system -lboost_filesystem -lpthread
FREEBSD_LIBS = -lxml2
WIN32_LIBS = -lxml2
